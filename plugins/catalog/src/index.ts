...
export { EntityPage, TECHDOCS_ANNOTATION, entityDetails, groupRelations, relationLabel } from './entity-page';
export type { EntityPageProps } from './entity-page';
export { EntityScreen } from './entity-screen';
export { DEFAULT_NAMESPACE, backstageEntityUrl, entityDocsHref, entityHref, entityRefOf, parseEntityRef, stringifyEntityRef } from './entity-ref';
