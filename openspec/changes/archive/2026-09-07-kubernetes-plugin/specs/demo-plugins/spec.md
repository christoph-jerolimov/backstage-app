...
kubernetes, auth, and settings plugins. Each plugin SHALL contribute exactly one
navigation item and one main page, and each package SHALL build, lint, and typecheck as
...
- **THEN** the drawer shows Home, Catalog, Search, Notifications, APIs, Docs, Kubernetes,
  Account, and Settings entries contributed by the respective plugin packages
